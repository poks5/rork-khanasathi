...
export const foodDatabase: Food[] = [
  ...
  },
  {
    ...
    category: 'proteins',
    subcategory: 'animal-protein',
    image: 'https://pub-e001eb4506b145aa938b5d3badbff6a5.r2.dev/attachments/fejusa78fmid10dxoqadj',
    defaultPortion: 1,
    unitEn: 'large',
    unitNe: 'ठूलो',
    weightGrams: 50,
  ...
  },
  {
    ...
    category: 'legumes',
    subcategory: 'dal',
    image: 'https://images.unsplash.com/photo-1599909533730-8b9d1b7e6b8a?w=200',
    defaultPortion: 1,
    unitEn: 'bowl',
    unitNe: 'कचौरा',
    weightGrams: 200,
  ...
  },
  {
    ...
    image: 'https://pub-e001eb4506b145aa938b5d3badbff6a5.r2.dev/attachments/u4jhsm2qkl4s7kd8pr9cx',
    defaultPortion: 1,
    unitEn: 'set',
    unitNe: 'सेट',
    weightGrams: 400,
