...
export const foodDatabase: Food[] = [
  ...
  // TRADITIONAL NEPALI FOODS
  {
    ...
    safetyLevel: 'caution',
    medicalNotes: [
      { en: 'High sodium from seasoning - limit portions', ne: 'मसलाबाट उच्च सोडियम - मात्रा सीमित गर्नुहोस्' },
    ],
  },
  {
    id: 'gundruk',
  ...
  },
  {
    ...
    safetyLevel: 'safe',
    medicalNotes: [
      { en: 'Good alternative to rice - lower potassium', ne: 'भातको राम्रो विकल्प - कम पोटासियम' },
    ],
  },
  {
    id: 'achar-mixed',
